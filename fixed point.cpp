//THis is a buggy code and it does not work.
//moreover, I am yet to understand the fixed point method.
//Firstly, I am not sure about the iteration variable update formula.
//Then again, I need to study fixed point method first to understand that!
